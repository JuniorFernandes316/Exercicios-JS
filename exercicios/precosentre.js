...
// Existe um array com os preços dos produtos. Um programador já criou uma
// função maisBaratosQue(valor, precos) que retorna um array com os preços 
//dos produtos mais baratos que o valor passado como parâmetro. 
//Outro programador já criou uma função maisCarosQue(valor, precos) que 
//retorna um array com os preços mais caros que o valor passado como parâmetro. Chegou sua vez!
//crie uma função precosEntre(valorMenor, valorMaior, precos) que deve utilizar 
//as funções maisBaratosQue e maisCarosQue para retornar os preços que 
//estão entre o valorMenor e o valorMaior. Sua função deve receber então dois parâmetros:

v//alorMenor para representar o valor mínimo dos preços a serem listados
